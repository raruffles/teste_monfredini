    ...
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-32 pb-20">
        ...
        >
          ...
          {/* Tracking */}
          <div className="bg-card/80 backdrop-blur-sm border border-border rounded-lg p-2 flex items-center gap-2 max-w-lg">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-foreground placeholder:text-muted-foreground text-sm outline-none py-2.5"
            />
            <button className="px-5 py-2.5 rounded-md bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-colors flex items-center gap-2 shrink-0">
              Rastrear
              <ArrowRight size={16} />
            </button>
          </div>
